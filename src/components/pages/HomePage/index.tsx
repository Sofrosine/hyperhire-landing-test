...
import {HOME_MENU_DESKTOP, HOME_MENU_MOBILE} from "@/constants/menus";
            ...
            <section className={'flex flex-col lg:grid lg:grid-cols-12 lg:gap-3.5'}>
                <div className={'lg:col-span-6 lg:mt-10'}>
                    ...
                    <CustomImage
                        ...
                        containerClassName={
                            'w-[9.375rem] h-[3rem] hidden lg:block home-tooltip-animation'
                        }
                    />
                    <h1 className={'text-4xl lg:text-5xl my-4 leading-[2.925rem] lg:leading-[3.9rem] animate-in fade-in slide-in-from-bottom duration-500'}>최고의 실력을 가진<br/>외국인 인재를 찾고 계신가요?</h1>
                    <p className={'text-lg leading-[1.6875rem] opacity-80 lg:hidden animate-in fade-in slide-in-from-bottom duration-500'}>법률 및 인사관리 부담없이 1주일 이내에 원격으로
                        채용해보세요.</p>
                    ...
                    <div className={'hidden lg:block mt-6'}>
                        <p className={'underline-skip-ink animate-in fade-in slide-in-from-bottom duration-500'}>개발자가 필요하신가요?</p>
                ...
                <div className={'mt-9 lg:mt-0 mb-6 lg:mb-0 lg:col-span-6'}>
                    <CustomImage src={'/images/tooltip-slider-home.png'} alt={'tooltip-slider-home'}
                ...
                <div className={'flex flex-wrap gap-2 mb-2'}>
                    {HOME_MENU_MOBILE.slice(0, 2).map(menu => (
                        <div key={menu?.label} className={'flex items-center gap-3 min-w-[6.8125rem]'}>
                            <CustomImage src={'/icons/ic-checkbox.svg'} alt={'ic-checkbox'}
