        ...
        >
            ...
            <Link href="/" className="flex items-center gap-2 text-base">
                ...
                <CustomImage
                    ...
                    alt={'ic-chevron'}
                    containerClassName={`h-4 w-4 transition-transform ${
            ...
            >
                ...
                {data?.map((item) => (
                    <div className={'rounded-lg'} key={item?.label}>
                        ...
                        <div
                            className="px-4 py-2.5 text-foreground-gray font-medium hover:bg-gray-100 hover:cursor-pointer">{item.label}</div>
                    </div>
                ))}
            </div>
        </div>
