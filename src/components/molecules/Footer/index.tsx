...
const Footer = () => {
    return (
        <footer className={'3xl:mt-4 3xl:ml-[6.125rem] px-4 lg:px-8 2xl:px-[18rem] 3xl:px-[21.625rem] pt-16 3xl:pt-20 pb-[3.75rem] 3xl:pb-20 text-foreground-gray bg-background'}>
            <section className={'flex flex-col lg:grid lg:grid-cols-12 lg:items-center'}>
                <div className={'lg:col-span-4'}>
                    <CustomImage src={'/images/logo.svg'} alt={'logo'}
                                 containerClassName={'w-[11.6875rem] h-[2.125rem]'}/>
                    <p className={'text-sm mt-4 text-foreground-black'}>우리는 국가의 장벽을 넘어 최고의 인재를 매칭해드립니다.</p>
            ...
            <section className={'flex flex-col mt-[3.75rem] gap-9 lg:gap-0 lg:grid lg:grid-cols-12 lg:mt-[2.875rem]'}>
                ...
                <div className={'flex flex-col gap-9 lg:gap-[2.625rem] lg:flex-row lg:col-span-8'}>
                    ...
                    <div>
                        ...
                        <p className={'text-13'}>D-138, Street number 11, Jagjeet Nagar, North East Delhi, New Delhi,
                            110053 India</p>
                    </div>
                </div>
            </section>
            <section className={'mt-9 lg:mt-7 text-13'}>
                ⓒ 2023 Hyperhire
            </section>
        </footer>
    );
